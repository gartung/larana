/////////////////////////////////////////////////////////////////////
///  Class:       PFParticleMCParticleMatching
///  Module Type: producer
///  File:        PFParticleMCParticleMatching_module.cc
///  Author:      Yun-Tse Tsai
...
class t0::PFParticleMCParticleMatching : public art::EDProducer {
public:
   explicit PFParticleMCParticleMatching( fhicl::ParameterSet const & p );
   // The destructor generated by the compiler is fine for classes
   // without bare pointers or other resource use.
   //
   // Plugins should not be copied or assigned.
   PFParticleMCParticleMatching( PFParticleMCParticleMatching const & ) = delete;
   PFParticleMCParticleMatching( PFParticleMCParticleMatching && ) = delete;
   PFParticleMCParticleMatching & operator = ( PFParticleMCParticleMatching const & ) = delete;
   PFParticleMCParticleMatching & operator = ( PFParticleMCParticleMatching && ) = delete;
...
t0::PFParticleMCParticleMatching::PFParticleMCParticleMatching( fhicl::ParameterSet const & p ) {
   reconfigure( p );
   produces< art::Assns< recob::PFParticle, simb::MCParticle, anab::BackTrackerMatchingData > > ();
}

void t0::PFParticleMCParticleMatching::reconfigure( fhicl::ParameterSet const & p ) {
...
void t0::PFParticleMCParticleMatching::beginJob() {
}

std::map< int, simb::MCParticle const* > t0::PFParticleMCParticleMatching::mapTrackIDToMCParticle( std::vector< simb::MCParticle > const& particles ) const {
...
std::vector< int > t0::PFParticleMCParticleMatching::createHierarchyList( std::map< int, simb::MCParticle const* > const& TrackIDToMCParticle, int trackID ) const {
...
void t0::PFParticleMCParticleMatching::produce( art::Event & evt ) {
   ...
   for ( size_t iMCPart = 0; iMCPart < MCParticleHandle->size(); ++iMCPart ) {
      ...
      for ( size_t iTrackID = 0; iTrackID < TrackIDList.size(); ++iTrackID ) {
         ...
         for ( auto const& hitPtr : hitPtrs ) {
            ...
            if ( clusterPtrs.size() > 1 ) {
               mf::LogWarning("PFParticleMCParticleMatching") << "===>> More than one Cluster associated to a Hit.";
               continue;
            }
            ...
            if ( pfpartPtrs.size() > 1 ) {
               mf::LogWarning("PFParticleMCParticleMatching") << "===>> More than one PFParticle associated to a Cluster.";
               continue;
            }
      ...
      mf::LogInfo("PFParticleMCParticleMatching") << "===>> " << MatchedPFParticles.size() << " PFParticles are involved with the MCParticle " << iMCPart;
...
DEFINE_ART_MODULE(t0::PFParticleMCParticleMatching)
