//////////////////////////////////////////////////////////////////////
// Class:       LiklihoodPIDMaker
// Module Type: analyzer
// File:        LiklihoodPIDMaker_module.cc
//
...
namespace LiklihoodPIDMaker {

  class LiklihoodPIDMaker : public art::EDAnalyzer {
  public:
    explicit LiklihoodPIDMaker(fhicl::ParameterSet const & p);
    // The destructor generated by the compiler is fine for classes
    // without bare pointers or other resource use.
  
    // Plugins should not be copied or assigned.
    LiklihoodPIDMaker(LiklihoodPIDMaker const &) = delete;
    LiklihoodPIDMaker(LiklihoodPIDMaker &&) = delete;
    LiklihoodPIDMaker & operator = (LiklihoodPIDMaker const &) = delete;
    LiklihoodPIDMaker & operator = (LiklihoodPIDMaker &&) = delete;
  ...
  bool LiklihoodPIDMaker::IsInTPC(const TVector3& pos) 
  { 
  ...
  art::Ptr<recob::Track> LiklihoodPIDMaker::MatchTrack(const simb::MCParticle& truePart, std::vector<art::Ptr<recob::Track>>& recoVect, art::Event const& event)
  {
  ...
  LiklihoodPIDMaker::LiklihoodPIDMaker(fhicl::ParameterSet const & p)
    :
    EDAnalyzer(p)
  ...
  void LiklihoodPIDMaker::beginJob()
  {
  ...
  void LiklihoodPIDMaker::reconfigure(fhicl::ParameterSet const & p)
  {
    ...
    if (fOldTruthMatching)
    {
      mf::LogWarning("LiklihoodPIDMaker: ") << " Using OldTruthMatching\n";
    }
    else if(fBackTrackMatching)
    {
      mf::LogWarning("LiklihoodPIDMaker: ") << " Using BackTrackMatcherAlg\n";
    }
    else
    {
      mf::LogWarning("LiklihoodPIDMaker: ") << " Using StartPosDirMatcherAlg\n";
    }
  }
  
  void LiklihoodPIDMaker::analyze(art::Event const & e)
  {
  ...
  } //LiklihoodPIDMaker::analyze()

  void LiklihoodPIDMaker::truthAnalyzer(const simb::MCParticle& truth) 
  {
      // reset
      ...
      //}
  } // LiklihoodPIDMaker::truthAnalyzer

  int LiklihoodPIDMaker::producesNTracks(const art::Ptr<recob::Track>& track, const art::Event& event)
  {
    int result = 0;
    ...
    return result;
  } // LiklihoodPIDMaker::producesNTracks

} //namespace LiklihoodPIDMaker

DEFINE_ART_MODULE(LiklihoodPIDMaker::LiklihoodPIDMaker)
#endif
